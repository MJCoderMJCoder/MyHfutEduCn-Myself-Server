...
public class Comment {
	 ...
	 *            发表该评论的用户的姓名
	 * @param commentUserPhone
	 *            发表该评论的用户的手机
	 * @param commentUserEmail
	 *            发表该评论的用户的邮箱
	 * @param commentUserGender
	 *            发表该评论的用户的性别
	 * @param commentUserBirthday
	 *            发表该评论的用户的出生日期
	 * @param commentUserDepart
	 *            发表该评论的用户所在学院
	 * @param commentUserMajor
	 *            发表该评论的用户的专业
	 * @param commentUserClass
	 *            发表该评论的用户的班级
	 * @param commentIsAnonymity
	 *            是否匿名评论
	 * @param replyUserName
	 ...
	 */
	public Comment(int commentId, Timestamp commentTime, String commentTxt, int commentLog, String commentUserName, String commentUserPhone, String commentUserEmail,
	 ...
	 *
	 * @param commentIsAnonymity
	 *            用户是否匿名发表该评论（true：匿名发表；false：实名发表）
	 */
